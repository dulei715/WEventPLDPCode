...
public class GeneralizedPersonalizedRandomResponse extends PersonalizedFrequencyOracle<GeneralizedRandomizedResponse> {
    public GeneralizedPersonalizedRandomResponse(Integer domainSize, TreeMap<Double, Integer> distinctBudgetCountMap, Class<GeneralizedRandomizedResponse> frequencyOracleClass) {
