...
public abstract class AblateOPSMechanism extends PersonalizedMechanism {
    ...
    protected Double samplingSubMechanism(List<Integer> nextDataIndexList) {
        ...
        CombinePair<Map<Integer, Double>, Map<Double, Integer>> enhancedGPRRInfo = MechanismUtils.enhancedGPRR(samplingPrivacyBudgetList, samplingDataIndexList, this.domainSize, this.random);
