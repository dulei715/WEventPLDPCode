...
public class FixedSegmentEnhancedParameterParallelRun implements Runnable {
    ...
    public FixedSegmentEnhancedParameterParallelRun(String basicPath, String dataTypeFileName, Integer singleBatchSize,
                                                    Double privacyBudget, Integer windowSize, Integer userSize, File[] timeStampDataFiles,
                                                    int startFileIndex, int endFileIndex, Integer segmentID, Random random,
